...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{url('/admin')}}" class="logo">
            ...
            <span class="logo-mini"><b>I</b>ME</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>IME</b></span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="{{url('admin/categories')}}"><i class="fa fa-address-book"></i>
                        <span>Categories</span></a></li>
                <li><a href="{{url('admin/posts')}}"><i class="fa fa-address-card"></i>
        ...
        @yield('content')
            <div class="row">
                @if(session('msg'))
                    ...
                    {{--
                                <div class="alert alert-success alert-dismissible"><p style="color: green">{{ session('msg') }}</p></div>
                    --}}
                @endif
            </div>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2019 <a href="#">Ahmad Gomaa</a>.</strong> All rights reserved.
    </footer>
